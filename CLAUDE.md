...
- **`install()` is serialized** on the `paycrypto_me_db_install` advisory lock (same
  ...
  [docs/PLAN-SCHEMA-INSTALL-HARDENING.md](docs/PLAN-SCHEMA-INSTALL-HARDENING.md) § "Deferred by
